...
const placeholderToken = "PLACE" + "HOLDER_";
const isPlaceholder = (value) =>
  typeof value === "string" && value.includes(placeholderToken);

const setText = (element, value) => {
  if (element && value !== undefined && value !== null && !isPlaceholder(value)) {
...
const loadContent = async () => {
  try {
    ...
    if (elements.contactPhone && site.contact?.phone && !isPlaceholder(site.contact.phone)) {
